    ...
    for prompt_template in prompt_templates:
        ...
        for adj in adjectives:
            ...
            for batch in tqdm(dataloader, desc=f"Prompt: {prompt_template}, Adjective: {adj}"):
                aae, sae = batch
                aae_batch = [b + adj for b in aae]
                sae_batch = [b + adj for b in sae]
