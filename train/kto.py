...
# QLoRA:
accelerate launch --multi_gpu --mixed_precision=fp16 --num_processes=2 --main_process_port=0 examples/scripts/kto.py \
...
class ScriptArguments:
    ...
    dataset_name: str = "trl-internal-testing/hh-rlhf-trl-style"
