...
from trl.trainer.utils import get_reward as get_value_reward
        ...
        for update in range(1, args.num_total_batches + 1):
            ...
            with torch.no_grad():
                ...
                for i in range(0, queries.shape[0], args.local_rollout_forward_batch_size):
                    ...
                    full_value, _, _ = get_value_reward(
                    ...
                    _, score, _ = get_reward(
                        reward_model, postprocessed_query_response_for_rm, tokenizer.pad_token_id, context_length
                    )
